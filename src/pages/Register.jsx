...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    if (!/[A-Z]/.test(data.password)) {
      return setFormError('La contraseña debe tener al menos una letra mayúscula.');
    }
      ...
      {showLogin ? (
        ...
        <main className='h-screen flex flex-col justify-center items-center max-w-[550px] m-auto gap-5'>
          <form
            ...
            className='border-2 border-[#DEDEDE] rounded-2xl p-8 flex flex-col h-[650px] w-[420px]'
          >
            ...
            <p className='text-center mt-4 text-gray-400'>or continue with these social profiles</p>
            <p className='text-center mt-7 text-gray-400'>
              Already have an account?{' '}
              <span className='text-blue-500 cursor-pointer' onClick={() => setShowLogin(true)}>
                Login
              </span>
            </p>
