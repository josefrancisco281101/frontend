...
function Dashboard() {
  ...
  return (
    <main className='flex flex-col justify-center items-center'>
      <div className=''>
        <nav className=' flex gap-[400px] items-center p-4 text-black'>
            ...
            {isMenuOpen && (
              <ul className="mt-2 w-48 bg-white shadow-lg rounded-lg py-2 p-2">
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer flex items-center">
                  <img className='h-[30px] mt-[4px]' src="profile.png" alt="" /> My Profile
                </li>
                <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer flex items-center">
                  <img className='h-[30px] mt-[4px]' src="group.png" alt="" /> Group Chat
                </li>
                <hr />
                <li
          ...
          {isEditing ? (
            <div className='p-8'>
              <div className='flex my-2 items-center'>
                ...
                <span className='ml-8 text-sm relative'>CHANGE PHOTO</span>
                <img className='absolute ml-4 icon-white' src="camara.png" alt="icon camara edit" />
              </div>
